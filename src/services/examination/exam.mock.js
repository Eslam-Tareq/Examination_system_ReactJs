...
function makeExams(status, startId, count, baseDate, dayOffset) {
    const titles = {
        upcoming: [
            "Midterm Exam",
            "Final Prep",
...
export const getExamsMockPaginated = async (status, page = 1, pageSize = 6) => {
...
export const getExamByIdMock = async (id) => {
